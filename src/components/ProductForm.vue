<template>
  <v-dialog :modelValue="showModal" width="95%" max-width="800px"
        ...
        <v-form @keydown.enter="submit" class="mt-6">
          <v-row>
            <v-col cols="12" md="7">
              ...
              <v-text-field label="Price*" type="number" v-model="form.price" :error-messages="errors.price?.[0]"
                prefix="$" class="mt-4" color="primary" />
            ...
            <v-col cols="12" md="5">
              ...
              <v-carousel hide-delimiters v-if="form.images.length > 0" height="300" class="mt-4">
                <v-carousel-item v-for="(image, index) in form.images" :key="index" :src="image"
